...
TestFloat<PR>::test_arithmetic()
{
    ...
    ARIADNE_TEST_EQUAL(div(down,pi_down,2),hlf(pi_down));
...
TestFloat<PR>::test_cosine()
{
    ...
    static const Float three_pi_down=mul(down,pi_down,three);
    static const Float three_pi_up  =mul(up  ,pi_up  ,three);

    ARIADNE_TEST_COMPARE(cos(up,div(down,pi_down,2)),>,0.0);

    ARIADNE_TEST_COMPARE(cos(up,hlf(pi_down)),>,0.0);
    ARIADNE_TEST_EQUAL(cos(up,Float(0.0)),1.0);
    ARIADNE_TEST_COMPARE(cos(up,third_pi_down),>,0.5);
    ARIADNE_TEST_COMPARE(sqr(up,cos(up,qtr(pi_down))),>,0.5);
    ARIADNE_TEST_COMPARE(cos(up,qtr(pi_down)),>,0.0);
    ARIADNE_TEST_COMPARE(cos(up,qtr(pi_up)),<=,0.0);
    ARIADNE_TEST_COMPARE(cos(up,pi_down),>,-1.0);
    ARIADNE_TEST_COMPARE(cos(up,pi_up),>,-1.0);
    ARIADNE_TEST_COMPARE(cos(up,twc(pi_down)),==,1.0);
    ARIADNE_TEST_COMPARE(cos(up,twc(pi_up)),==,1.0);
    ARIADNE_TEST_COMPARE(cos(up,three_pi_down),>,-1.0);
    ARIADNE_TEST_COMPARE(cos(up,three_pi_up),>,-1.0);

    ARIADNE_TEST_EQUAL(cos(down,Float(0.0)),1.0);
    ARIADNE_TEST_COMPARE(cos(down,third_pi_up),<,0.5);
    ARIADNE_TEST_COMPARE(sqr(down,cos(down,qtr(pi_up))),<,0.5);
    ARIADNE_TEST_COMPARE(cos(down,hlf(pi_down)),>=,0.0);
    ARIADNE_TEST_COMPARE(cos(down,hlf(pi_up)),<,0.0);
    ARIADNE_TEST_COMPARE(cos(down,pi_down),==,-1.0);
    ARIADNE_TEST_COMPARE(cos(down,pi_up),==,-1.0);
    ARIADNE_TEST_COMPARE(cos(down,twc(pi_down)),<,1.0);
    ARIADNE_TEST_COMPARE(cos(down,twc(pi_up)),<,1.0);
    ARIADNE_TEST_COMPARE(cos(down,three_pi_down),==,-1.0);
    ARIADNE_TEST_COMPARE(cos(down,three_pi_up),==,-1.0);
...
TestFloat<DoublePrecision>::test_arctan()
{
    ...
    static const FloatDP third_pi_down=1.0471975511965976;
    static const FloatDP third_pi_up  =1.0471975511965978;

    static const FloatDP quarter_pi_down=0.7853981633974483;
    //static const FloatDP quarter_pi_near=0.7853981633974483;
    static const FloatDP quarter_pi_up  =0.7853981633974484;

    static const FloatDP sixth_pi_down=0.52359877559829882;
    static const FloatDP sixth_pi_up  =0.52359877559829893;
    ...
    static const FloatDP sqrt_rec_three_down=0.57735026918962573;
    //static const FloatDP sqrt_three_near=0.57735026918962573;
    static const FloatDP sqrt_rec_three_up  =0.57735026918962584;


    static const FloatDP zero=0.0;
    static const FloatDP one=1.0;
    static const FloatDP quarter=0.25;
    ...
    ARIADNE_TEST_COMPARE(atan(up,sqrt_rec_three_down),>=,sixth_pi_up);
    ARIADNE_TEST_COMPARE(atan(up,-sqrt_rec_three_up),>=,-sixth_pi_down);
    ...
    ARIADNE_TEST_COMPARE(atan(down,sqrt_rec_three_up),<=,sixth_pi_down);
    ARIADNE_TEST_COMPARE(atan(down,-sqrt_rec_three_down),<=,-sixth_pi_up);
...
TestFloat<PR>::test_arctan()
{
    ...
    ARIADNE_TEST_COMPARE(mul(up,atan(up,+sqrt_rec_three_down),six),>=,pi_up);
    ARIADNE_TEST_COMPARE(mul(up,atan(up,-sqrt_rec_three_up),six),>=,-pi_down);
    ...
    ARIADNE_TEST_COMPARE(mul(down,atan(down,+sqrt_rec_three_up),six),<=,pi_down);
    ARIADNE_TEST_COMPARE(mul(down,atan(down,-sqrt_rec_three_down),six),<=,-pi_up);
