  ...
  : public pybind11::wrapper<IntegratorInterface>
{
  public:
    ...
    Pair<FloatDPValue,UpperBoxType> flow_bounds(const ValidatedVectorMultivariateFunction& vf, const ExactBoxType& D, const RawFloatDP& h) const {
        return this->get_override("flow_bounds")(vf,D,h); }
    ValidatedVectorMultivariateFunctionModelDP flow_step(const ValidatedVectorMultivariateFunction& vf, const ExactBoxType& D, RawFloatDP& h) const {
        return this->get_override("flow_step")(vf,D,h); }
    ValidatedVectorMultivariateFunctionModelDP flow_step(const ValidatedVectorMultivariateFunction& vf, const ExactBoxType& D, const FloatDPValue& h, const UpperBoxType& B) const {
...
Void export_integrators(pybind11::module& module)
{
    ...
    integrator_interface_class.def("flow_bounds",(Pair<FloatDPValue,UpperBoxType>(IntegratorInterface::*)(const ValidatedVectorMultivariateFunction&, const ExactBoxType&, const RawFloatDP&)const)&IntegratorInterface::flow_bounds);
    integrator_interface_class.def("flow_step",(ValidatedVectorMultivariateFunctionModelDP(IntegratorInterface::*)(const ValidatedVectorMultivariateFunction&, const ExactBoxType&, RawFloatDP&)const)&IntegratorInterface::flow_step);
    integrator_interface_class.def("flow_step",(ValidatedVectorMultivariateFunctionModelDP(IntegratorInterface::*)(const ValidatedVectorMultivariateFunction&,const ExactBoxType&,const FloatDPValue&,const UpperBoxType&)const)&IntegratorInterface::flow_step);
