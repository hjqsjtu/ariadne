...
{
    pybind11::class_<ScalarMultivariateFunction<P>> scalar_function_class(module,(class_name<P>()+"ScalarFunction").c_str());
...
{
    pybind11::class_<VectorMultivariateFunction<P>> vector_function_class(module,(class_name<P>()+"VectorFunction").c_str());
