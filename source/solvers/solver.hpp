    ...
    : public SolverInterface
{
  public:
    ...
    virtual ValidatedVectorMultivariateFunctionModel implicit(const ValidatedVectorMultivariateFunction& f, const ExactBoxType& par, const ExactBoxType& ix) const;
    /*! \brief Solve \f$f(a,x)=0\f$ for a in \a par, looking for a solution with x in \a ix. */
    virtual ValidatedScalarMultivariateFunctionModel implicit(const ValidatedScalarMultivariateFunction& f, const ExactBoxType& par, const ExactIntervalType& ix) const;
    ...
    virtual ValidatedVectorMultivariateFunctionModel continuation(const ValidatedVectorMultivariateFunction& f, const Vector<ApproximateNumericType>& a, const ExactBoxType& X, const ExactBoxType& A) const;
  ...
  protected:
    ...
    /*! \brief Perform one iterative step of the contractor. */
    virtual ValidatedVectorMultivariateFunctionModel implicit_step(const ValidatedVectorMultivariateFunction& f,const ValidatedVectorMultivariateFunctionModel& p,const ValidatedVectorMultivariateFunctionModel& x) const = 0;
  private:
    ...
    : public SolverBase
{
  ...
  public:
    virtual ValidatedVectorMultivariateFunctionModel implicit_step(const ValidatedVectorMultivariateFunction& f, const ValidatedVectorMultivariateFunctionModel& p, const ValidatedVectorMultivariateFunctionModel& x) const;
