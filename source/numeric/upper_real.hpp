...
//! \brief Upper upper_real number type \f$\R_>\f$.
//! An effectively computable <em>upper upper_real</em> is a upper_real number for which it is possible to compute arbitrarily accurate (dyadic) rational upper bounds;
...
//!
//! %Positive upper upper_real numbers are a natural type for representing upper bounds of a distance or norm,
    ...
    : public DirectedAbelian<UpperReal,LowerReal>
{
  ...
  public:
    ...
    friend UpperReal limit(DecreasingSequence<Dyadic> const& qubs);
        //!< Create a upper_real number from an decreasing sequence of dyadic upper bounds.
    //@}
...
//! \brief Computable lower upper_real numbers defined by conversion to concrete floats.
